...
export const dictionary = {
  en: {
    ...
    home: {
      eyebrow: 'Artistic Director - DJ - Event Curator',
      title: ['Visionary', 'Storyteller', 'Experience', 'Curator'],
      intro:
      ...
      featuredKicker: 'Featured Sets',
      featuredTitleA: 'Stories Worth',
      featuredTitleB: 'Reliving',
      ...
      testimonialsSub: "Stories from the people we've had the privilege to work with.",
  ...
  fr: {
    ...
    home: {
      eyebrow: 'Directeur artistique - DJ - Curateur d experiences',
      title: ['Visionnaire', 'Narrateur', 'Createur', 'd experiences'],
      intro:
        'Base a Paris, Samuell relie narration cinematographique et experiences live sur mesure en Europe, au Moyen-Orient et au-dela.',
      ctaBlaze: 'Voir Blaze',
      ctaKolasi: 'Decouvrir Kolasi',
      featuredKicker: 'Selections',
      featuredTitleA: 'Des histoires a',
      featuredTitleB: 'revivre',
      blazeKicker: 'Blaze Production',
      ...
      testimonialsSub: 'Des retours de celles et ceux avec qui nous avons eu le privilege de travailler.',
