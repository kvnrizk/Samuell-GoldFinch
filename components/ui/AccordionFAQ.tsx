...
function AccordionItem({
  ...
  return (
    <div className="border border-white/[0.08] rounded-xl overflow-hidden bg-white/[0.02]">
      ...
      >
        <span className="font-serif text-base font-medium text-stone-100 group-hover:text-ivory transition-colors pr-4">
          {question}
        </span>
        <span
          className={`text-ivory text-lg transition-transform duration-300 flex-shrink-0 ${
            isOpen ? 'rotate-45' : ''
          }`}
        >
          +
