      ...
      <section id="venue-hero" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, color-mix(in srgb, var(--media-scrim) 95%, transparent) 0%, color-mix(in srgb, var(--media-scrim) 40%, transparent) 50%, color-mix(in srgb, var(--media-scrim) 60%, transparent) 100%)',
            }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 md:py-40">
          <div className="max-w-3xl venue-reveal">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-on-media leading-tight mb-6">
              {t.heroTitle}
            </h1>
            <ul className="space-y-2 mb-8">
              {t.bullets.map((line, i) => (
                <li key={i} className="flex items-start gap-3 text-on-media-dim text-sm md:text-base">
                  <span className="w-1.5 h-1.5 rounded-full bg-ivory mt-2 flex-shrink-0" />
                  {line}
                </li>
              ))}
            </ul>
            ...
            <button
              ...
              className="flex items-center gap-2 ui-caption text-on-media-dim hover:text-ivory transition-colors mb-8"
            >
              ...
              {artists.map((artist) => {
                ...
                return artist.slug ? (
                  <Link
                    ...
                    className="group relative aspect-[3/4] rounded-2xl overflow-hidden border block transition-colors hover:border-ivory/30"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="venue-reveal">
              ...
              <div className="space-y-4 mb-8">
                <button
                  onClick={handleCallClick}
                  className="flex items-center gap-3 text-ivory hover:text-[#e4e4e7] transition-colors text-sm font-medium"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <button
                  onClick={handleWhatsApp}
                  className="flex items-center gap-3 text-zinc-500 hover:text-ivory transition-colors text-sm"
                >
