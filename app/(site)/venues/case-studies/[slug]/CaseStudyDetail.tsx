  ...
  return (
    <div ref={containerRef} className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <Link
          href="/venues"
          className="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-[#c8a96e] transition-colors mb-12 cs-reveal"
        >
        ...
        <div className="text-center py-12 border-t border-white/[0.08] cs-reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              ...
              className="bg-[#c8a96e] text-[#09090b] font-semibold text-sm px-8 py-3.5 rounded-lg hover:bg-[#d4b87a] transition-all"
            >
              Apply Now
            </Link>
            <Link
